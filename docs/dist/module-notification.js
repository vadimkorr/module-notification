...
var module_notification = __webpack_require__(2);

// EXTERNAL MODULE: ./src/css/glyph.css
var glyph = __webpack_require__(3);

// EXTERNAL MODULE: ./node_modules/jquery/dist/jquery.js
var jquery = __webpack_require__(0);

// EXTERNAL MODULE: ./node_modules/cuid/dist/browser-cuid.js
var browser_cuid = __webpack_require__(1);
...
var templater = function templater(_ref) {
  ...
  return function (t) {
    ...
    return (t ? t[0] : "").replace(idPlaceholder, id).replace(titlePlaceholder, title).replace(messagePlaceholder, message).replace(typePlaceholder, type).replace(iconPlaceholder, icon);
  };
};
  ...
  MNNotification_createClass(MNNotification, [{
    ...
    value: function pull() {
      ...
      if (typeof _self.onBeforeRemove === "function") {
        ...
        jquery("#" + _self.id).fadeOut(300, function () {
    ...
    value: function appendToContainer(additionalOptions) {
      ...
      var _getCustomTemplate = function _getCustomTemplate(title, message) {
        var template = "<div id='" + _self.id + "'>" + _self.options.template(title, message) + "</div>";
        return template;
      };

      var _getTemplate = function _getTemplate() {
        var template = typeof _self.options.template == "function" ? _getCustomTemplate(_self.options.title, _self.options.message) : getDefaultTemplate(_self.id, _self.options.title, _self.options.message, _self.options.type, _self.options.icon);
        return template;
      };

      var _getCloseBtnSelector = function _getCloseBtnSelector() {
      ...
      (function append() {
        if (additionalOptions.direction == "fromTop") {
          jquery(_getTemplate()).appendTo("#" + additionalOptions.moduleId).hide().fadeIn(300);
        } else {
          jquery(_getTemplate()).prependTo("#" + additionalOptions.moduleId).hide().fadeIn(300);
        }
      })();

      (function setCloseConditions() {
        jquery(_getCloseBtnSelector()).on("click", function () {
          _self.pull();
        });
...
function () {
  function MNModule(moduleOptions) {
    ...
    jquery("<div id='" + this.id + "' class='mn-module-container'></div>").appendTo(this.options.container);
